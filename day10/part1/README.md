...
## Solution
I initially overthought this, but checking the input file revealed the constraints were small enough for a smart brute-force. I converted the light patterns into binary numbers so I could toggle them using fast XOR operations. By checking button combinations starting from the smallest group size, I was guaranteed to find the fewest presses instantly without needing complex pathfinding algorithms.